...
class Auth extends Component {
  ...
  loginHandler = async () => {
    ...
    try {
      const response = await axios.post('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyA_1MNms8R6BMUS5DDl4Ve97skPkf_R4tw', authData)
  ...
  registerHandler = async () => {
    ...
    try {
      const response = await axios.post('https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyA_1MNms8R6BMUS5DDl4Ve97skPkf_R4tw', authData)
